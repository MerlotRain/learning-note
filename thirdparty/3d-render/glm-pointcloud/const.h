...
/// ZERO_TOLERANCE_SCALAR is used to set or compare a double variable to "close to zero".
constexpr double ZERO_TOLERANCE_SCALAR = std::numeric_limits<double>::epsilon();

/// ZERO_TOLERANCE_POINT_COORDINATE is used to set or compare a float variable to "close to zero".
constexpr double ZERO_TOLERANCE_POINT_COORDINATE = std::numeric_limits<float>::epsilon();

/// '1' as a float value
/** To avoid compiler warnings about 'possible loss of data' **/
constexpr float PC_ONE = static_cast<float>(1.0);

/// 'NaN' as a float value
/** \warning: handle with care! **/
constexpr float PC_NAN = std::numeric_limits<float>::quiet_NaN();

/// NaN as a double value
/** \warning: handle with care! **/
