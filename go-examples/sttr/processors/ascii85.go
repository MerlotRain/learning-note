...
func (p ASCII85Encoding) Transform(data []byte, opts ...Flag) (string, error) {
...
func (p ASCII85Decoding) Description() string {
	return "Decode your Ascii85 ( Base85 ) text back to normal"
}
